...
class Ef::Service::Webstack::ClientRegistry < Ef::Pack::Actor
  ...
  def add_client!(client, topic = nil)
    ...
    clients_announce! "CONNECT: #{uuid}", topic, uuid if DEBUG_SERVICES
  ...
  def clients_present!
    clients_announce! "Connected clients: #{size}" if DEBUG_SERVICES
